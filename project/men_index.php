            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <h5 class="col-md-6 text-center">
                        ...
                        <a href="men_insert.php" class="fas fa-plus col-md-1 text-center" style="font-size: 2.5em; "></a>
                </div>
            </div>
                    ...
                    <?php 
                        ...
                        if ($result->num_rows > 0) {
                            while($row = $result->fetch_assoc()) {
                                ...
                                echo '<a href="men_edit.php?number=' . $row['number'] . '" class="fas fa-edit col-md-1 text-center" style="font-size: 2.0em;"></a>';
                                echo "</div></div>";
                                echo '<!-- Modal -->
